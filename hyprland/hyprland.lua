...
local monitor1 = "eDP-1" -- laptop
local monitor2 = "eDP-1" -- laptop
-- local monitor1 = "DP-5" -- desktop
-- local monitor2 = "DP-6" -- dekstop
...
-- hl.monitor(desktopMonitorLeft)
-- hl.monitor(desktopMonitorRight)
...
hl.workspace_rule({ workspace = "0", monitor = monitor2 })
...
local menu        = "$HOME/.config/hypr/scripts/toggle_fzf_runner.sh"
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"#fabd2fee", "#d79921ee"}, angle = 45 },
...
hl.animation({ leaf = "windowsIn",     enabled = true,  speed = 2.1, bezier = "easeOutQuint",         style = "popin 87%", style = "popin 87%" })
...
-- Desktop keybinds
hl.bind("F7", hl.dsp.exec_cmd("wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+"), { locked = true, repeating = true })
hl.bind("F6", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-"),      { locked = true, repeating = true })
hl.bind("F5",        hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle"),     { locked = true, repeating = true })
